...
public class OrderGUI extends JFrame implements ActionListener{
    ...
    private void setupCenterPanel(ItemCategory category) {
        if(centerPanel != null){
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("Hot Drinks")) {
            this.setupCenterPanel(ItemCategory.HotDrink);
        }
        if (e.getActionCommand().equals("Cold Drinks")) {
            this.setupCenterPanel(ItemCategory.ColdDrink);
        }
        if (e.getActionCommand().equals("Dessert")) {
            this.setupCenterPanel(ItemCategory.Pastry);
        }
        if (e.getActionCommand().equals("Meal")) {
            this.setupCenterPanel(ItemCategory.Meal);
        }
    }
}
